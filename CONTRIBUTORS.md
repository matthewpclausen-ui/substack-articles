...
Hannah is a product manager at DoorDash and the author of In the Weeds, a newsletter on practical AI workflows for non-technical professionals. She started her career in Google's Associate Product Manager program, working on Google Maps and YouTube, before joining early-stage startups.
...
**Articles in this repo:** All articles

## Sidwyn Koh

Sidwyn is a staff software engineer at Meta and the creator of Path to Staff, a newsletter helping engineers accelerate their careers through practical insights on leveling up in tech.

- [Path to Staff (Substack)](https://www.pathtostaff.com/)
...
Joel is an AI leadership coach, strategist, and creator of Leadership in Change, a newsletter and podcast focused on human-centered AI strategy for leaders navigating implementation challenges.

- [Leadership in Change (Substack)](https://leadershipinchange.com/)
